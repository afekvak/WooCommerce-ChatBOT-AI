...
//   // special handling for intro plus card from tools
//   if (
//     !isUser &&
...
//     // intro bubble, plain text
//     if (introPart) {
//       addMessageToDOM(introPart, false, false);
//     }

//     // body bubble, allow html so the product card renders
//     if (bodyPart) {
//       addMessageToDOM(bodyPart, false, true);
//     }

//     return; // we already rendered both bubbles
//   }
